...
export const getStaticPaths: GetStaticPaths = async () => {
  // Your task is to:
  // 1. Define possible paths with multiple segments
...
export const getStaticProps: GetStaticProps<Props> = async ({ params }) => {
  // Your task is to:
  // 1. Get the params array from the URL
...
const MultipleParamsStarter = ({ params, possiblePaths }: Props) => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">Multiple Parameters Exercise</h1>

      <div className="mb-8">
        <p className="mb-4">
          Your task is to implement multiple dynamic parameters using{" "}
          <code>[...params]</code>. Follow these steps:
        </p>

        <ol className="list-decimal ml-8 mb-6 space-y-2">
          <li>Define paths with multiple segments</li>
          <li>Handle different types of paths (e.g., category, search)</li>
            ...
            <div className="space-y-2">
              <div>
                ...
                <p className="text-blue-600">
                  {params.length ? params.join(" / ") : "No parameters"}
                </p>
              </div>
              <div>
          ...
          <div className="grid gap-2">
            {possiblePaths.length === 0 ? (
              ...
              possiblePaths.map((item) => (
                <Link
                  key={item.path.join("/")}
                  href={`/concepts/dynamic-routes/starter/multiple/${item.path.join(
                    "/"
                  )}`}
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
          ...
          <ul className="list-disc ml-6 mt-2 text-black">
            <li>Define paths with multiple segments</li>
            <li>Include different types of paths (category, search)</li>
            <li>Handle nested navigation</li>
            <li>Create proper URL structure</li>
      ...
      <div className="flex space-x-4">
        <Link
          href="/concepts/dynamic-routes/solution/multiple"
...
export default MultipleParamsStarter;
